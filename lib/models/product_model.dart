  ...
  static List<ProductModel> getProducts() {
    ...
    products.addAll(
      ...
      ProductModel(
        ...
        productDesc:
            "Основная функция Магния – поддержка нервной системы и повышение устойчивости организма к стрессу. Если уровень магния понижен, то нам сложнее справляться с эмоциональным перенапряжением и физическими нагрузками. Возможны и более серьезные последствия: судороги, повышение артериального давления, нарушение сердечного ритма, появление риска развития остеопороза, инфарктов и инсультов.",
        productWeight: 0.8,
        typeProductId: 5,
        warehouseId: 5,
        productCost: 1657,
